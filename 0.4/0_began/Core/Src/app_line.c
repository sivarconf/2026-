 ...
 * 修改参数只需改这里
 * ===================================================== */
#define B_BASE_PWM   1250
#define B_KP         12   
#define B_KI         0
#define B_KD         5   

#define F_BASE_PWM   750
#define F_KP         12
#define F_KI         0
#define F_KD         4
/* ===================================================== */
...
void App_Line_Task(void)
{
    ...
    /* 根据题目类型选择速度/PID参数 */
    {
        QuestionType_t q = App_State_GetQuestion();
        if (q == QUESTION_B) {
            s_base_pwm = s_question_params[QUESTION_B].base_pwm;
            s_Kp       = s_question_params[QUESTION_B].Kp;
            s_Ki       = s_question_params[QUESTION_B].Ki;
            s_Kd       = s_question_params[QUESTION_B].Kd;
        } else {
            s_base_pwm = s_question_params[QUESTION_F].base_pwm;
            s_Kp       = s_question_params[QUESTION_F].Kp;
            s_Ki       = s_question_params[QUESTION_F].Ki;
            s_Kd       = s_question_params[QUESTION_F].Kd;
        }
    }
